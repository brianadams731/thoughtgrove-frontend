...
const VoteChevron = ({fill, width, isUpVote, hoverFill}:Props):JSX.Element =>{
    return(
        <motion.svg width={width} viewBox="0 0 39 27" animate={{fill}} whileHover={hoverFill?{fill:hoverFill}:{}} transition={{duration:.2}} style={isUpVote?{transform:"scaleY(-1)"}:{}} xmlns="http://www.w3.org/2000/svg">
