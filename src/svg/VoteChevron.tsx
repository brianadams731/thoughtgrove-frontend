...
const VoteChevron = ({fill, width, isUpVote}:Props):JSX.Element =>{
    return(
        <motion.svg width={width} height="27" viewBox="0 0 39 27" animate={{fill}} transition={{duration:.2}} style={isUpVote?{transform:"scaleY(-1)"}:{}} xmlns="http://www.w3.org/2000/svg">
